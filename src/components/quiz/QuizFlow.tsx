...
type Stage = "quiz" | "calculating" | "email" | "result";
...
export default function QuizFlow() {
  ...
  const getTier = (score: number) => {
    return (
      scoreTiers.find((t) => score >= t.range[0] && score <= t.range[1]) ||
      scoreTiers[0]
    );
  };
        ...
        <div className="flex min-h-[calc(100vh-80px)] flex-col items-center px-4 pt-8 pb-16">
          <div className="flex w-full max-w-lg flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-3">
                  {getRelevantFixes().map((fix, idx) => (
                    ...
                    >
                      ...
                      <p className="font-outfit text-sm text-[#232323]">
                        {fix.text}
                      </p>
                    </div>
                  ))}
            ...
            <div className="mt-10 flex w-full flex-col gap-3">
              ...
              <Link
                href="/calculator"
                className="flex items-center justify-between rounded-2xl border border-[#DEE2E6] bg-white px-5 py-4 text-left transition-colors hover:border-[#E96D1F] hover:bg-[#E96D1F]/5"
              >
                <div>
              ...
              <Link
                href="/"
                className="mt-2 text-center font-outfit text-xs font-medium text-[#6C757D] underline-offset-4 transition-colors hover:text-[#232323] hover:underline"
              >
